...
const PartnerForm = () => {
  ...
  const subtitle = isEdit ? t('partners.formSubtitleEdit') : t('partners.formSubtitleCreate');
  ...
  return (
    <>
      ...
      <div className="card-header sit-page-header">
        ...
        <p className="sit-page-subtitle mb-0">{subtitle}</p>
      </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-3">
                ...
                <select className="form-select" {...register('flow', { required: true })}>
                  {FLOWS.map((f) => <option key={f} value={f}>{getFlowLabel(t, f)}</option>)}
                </select>
              </div>
              <div className="col-lg-3">
